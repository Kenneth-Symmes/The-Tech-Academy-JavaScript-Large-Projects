...
// With both the meat and veggies functions each item in the array will be
...
function getCheese(runningTotal,text1) {
	...
	console.log(selectedCheese+" cheese = "+"$"+cheeseTotal+".00");
...
function getSauce(runningTotal, text1) {
	...
	console.log("total selected sauce items: " + selectedSauce);
	console.log(selectedSauce + " sauce = " + "$" + sauceTotal + ".00");
...
function getCrust(runningTotal, text1) {
	...
	console.log("total selected crust items: " + selectedCrust);
	console.log(selectedCrust + " crust = " + "$" + crustTotal + ".00");
